...
ALTER TABLE workspace_stats RENAME TO tb_workspace_stats;
...
COMMENT ON TABLE tb_workspace_stats IS 'Workspace Collection: Aggregated statistics per workspace';
